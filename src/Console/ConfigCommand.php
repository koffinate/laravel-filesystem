...
namespace Koffinate\S3\Console;

class ConfigCommand extends \Illuminate\Console\Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'koffinate:s3-config';
    ...
    public function handle(): void
    {
        ...
        $koffinateConfig = __DIR__ . '/../config.stub';
